...
<%@ Page Language="vb" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="Grid_Editing_PopupControlInEditForm_PopupControlInEditForm" %>
...
<body>
	...
	<dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="AccessDataSource1" KeyFieldName="EmployeeID" AutoGenerateColumns="False" OnRowUpdating="grid_RowUpdating" Width="50%">
		...
		<Templates>
			...
			<input type="button" value="Show Notes" onclick="<%#Container.UniqueID.Replace("$"c, "_"c) & "_popup.ShowAtElement(grid.GetMainElement());"%>" />
